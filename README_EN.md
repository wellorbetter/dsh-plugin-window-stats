...
- 📊 **Aggregate header**: total sessions, running count, summed input/output tokens, total duration, and total cost at a glance.
...
- 🔒 **Read-only & local-only**: no outbound network requests, no session writes.
