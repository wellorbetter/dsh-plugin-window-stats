window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = ".Ld-dQq_root{flex-direction:column;gap:14px;height:100%;padding:4px 2px;display:flex;overflow:auto}.Ld-dQq_ranges{flex-wrap:wrap;gap:6px;display:flex}.Ld-dQq_range{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:999px;padding:4px 12px;font-size:12px}.Ld-dQq_range:hover{background:var(--dsw-alias-interactive-bg-hover)}.Ld-dQq_rangeActive{color:#fff;border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-primary);font-weight:600}.Ld-dQq_customRange{align-items:center;gap:4px;display:inline-flex}.Ld-dQq_customInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);width:56px;color:var(--dsw-alias-label-primary);border-radius:6px;padding:3px 8px;font-size:12px}.Ld-dQq_customSelect{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-primary);border-radius:6px;padding:3px 6px;font-size:12px}.Ld-dQq_summary{grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:8px;display:grid}.Ld-dQq_stat{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-shadow-lv1);border-radius:10px;flex-direction:column;gap:2px;padding:8px 12px;display:flex}.Ld-dQq_stat[data-accent=business] .Ld-dQq_statValue{color:var(--dsw-alias-state-business-primary)}.Ld-dQq_stat[data-accent=warn] .Ld-dQq_statValue{color:var(--dsw-alias-state-warn-primary)}.Ld-dQq_stat[data-accent=success] .Ld-dQq_statValue{color:var(--dsw-alias-state-success-primary)}.Ld-dQq_statLabel{color:var(--dsw-alias-label-tertiary);font-size:12px}.Ld-dQq_statValue{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:15px;font-weight:600}.Ld-dQq_section{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);box-shadow:var(--dsw-shadow-lv1);border-radius:10px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.Ld-dQq_sectionTitle{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;font-size:12px;font-weight:600;display:flex}.Ld-dQq_sectionTitle:before{content:\"\";background:var(--accent,var(--dsw-alias-label-tertiary));border-radius:50%;flex:none;width:8px;height:8px}.Ld-dQq_section[data-accent=business]{--accent:var(--dsw-alias-state-business-primary)}.Ld-dQq_section[data-accent=warn]{--accent:var(--dsw-alias-state-warn-primary)}.Ld-dQq_section[data-accent=success]{--accent:var(--dsw-alias-state-success-primary)}.Ld-dQq_emptyHint{color:var(--dsw-alias-label-tertiary);font-size:13px}.Ld-dQq_toolRow{grid-template-columns:110px 1fr 70px 70px;align-items:center;gap:10px;font-size:12px;display:grid}.Ld-dQq_toolName{color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,monospace);white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.Ld-dQq_toolTrack{background:var(--dsw-alias-interactive-bg-hover);border-radius:3px;height:7px;overflow:hidden}.Ld-dQq_toolFill{background:var(--dsw-alias-state-business-primary);border-radius:3px;height:100%}.Ld-dQq_toolCount{color:var(--dsw-alias-label-secondary);text-align:right;font-variant-numeric:tabular-nums}.Ld-dQq_toolDur{color:var(--dsw-alias-label-primary);text-align:right;font-variant-numeric:tabular-nums}.Ld-dQq_turnRow{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.Ld-dQq_turnHead{justify-content:space-between;align-items:baseline;display:flex}.Ld-dQq_turnTime{color:var(--dsw-alias-label-secondary);font-size:11px}.Ld-dQq_turnDur{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px}.Ld-dQq_turnPrompt{color:var(--dsw-alias-label-primary);-webkit-line-clamp:2;overflow-wrap:anywhere;-webkit-box-orient:vertical;font-size:13px;display:-webkit-box;overflow:hidden}.Ld-dQq_turnTools{flex-wrap:wrap;gap:4px;display:flex}.Ld-dQq_toolTag{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-secondary);font-size:11px;font-family:var(--ds-font-family-code,monospace);border-radius:999px;padding:1px 7px}.Ld-dQq_chartBox{max-width:460px}.Ld-dQq_chart{width:100%;height:auto;display:block}.Ld-dQq_chartGrid{stroke:var(--dsw-alias-border-l2);stroke-width:1px}.Ld-dQq_chartAxis{fill:var(--dsw-alias-label-tertiary);font-size:10px}.Ld-dQq_chartBarIn{fill:var(--dsw-alias-state-business-primary);opacity:.28}.Ld-dQq_chartBarOut{fill:var(--dsw-alias-state-business-primary);opacity:.75}.Ld-dQq_chartArea{fill:url(#wsTrendFill)}.Ld-dQq_chartAreaTop{stop-color:var(--dsw-alias-state-business-primary);stop-opacity:.16}.Ld-dQq_chartAreaBottom{stop-color:var(--dsw-alias-state-business-primary);stop-opacity:0}.Ld-dQq_chartLine{fill:none;stroke:var(--dsw-alias-state-business-primary);stroke-width:2px;stroke-linejoin:round;stroke-linecap:round}.Ld-dQq_chartDot{fill:var(--dsw-alias-bg-layer-1);stroke:var(--dsw-alias-state-business-primary);stroke-width:2px}.Ld-dQq_chartEmpty{color:var(--dsw-alias-label-tertiary);font-size:12px}.Ld-dQq_chartLegend{gap:14px;margin-top:6px;display:flex}.Ld-dQq_legendItem{color:var(--dsw-alias-label-secondary);align-items:center;gap:5px;font-size:11px;display:inline-flex}.Ld-dQq_legendBarIn{background:var(--dsw-alias-state-business-primary);opacity:.28;border-radius:2px;width:9px;height:9px}.Ld-dQq_legendBarOut{background:var(--dsw-alias-state-business-primary);opacity:.75;border-radius:2px;width:9px;height:9px}.Ld-dQq_legendLine{background:var(--dsw-alias-state-business-primary);border-radius:1px;width:12px;height:2px}.Ld-dQq_toolLayout{align-items:flex-start;gap:14px;display:flex}.Ld-dQq_donutWrap{flex:0 0 96px}.Ld-dQq_donut{width:96px;height:96px}.Ld-dQq_toolRows{flex-direction:column;flex:1;gap:6px;min-width:0;display:flex}";
		...
		var SessionAnalyticsView_module_css_default = {
			...
			"stat": "Ld-dQq_stat",
			"chartBarOut": "Ld-dQq_chartBarOut",
			...
			"chartBarIn": "Ld-dQq_chartBarIn",
			"chartArea": "Ld-dQq_chartArea",
		...
		*/
		...
		function TokenTrendChart({ history, now, rangeMs, t }) {
			...
			const areaPath = series.length === 1 ? "" : `${topPath} L${xOf(series.length - 1).toFixed(1)},${baseline} L${xOf(0).toFixed(1)},${baseline} Z`;
				...
				children: [(0, react_jsx_runtime.jsxs)("svg", {
					...
					children: [
						(0, react_jsx_runtime.jsx)("defs", { children: (0, react_jsx_runtime.jsxs)("linearGradient", {
							...
							children: [(0, react_jsx_runtime.jsx)("stop", {
								offset: "0%",
								className: SessionAnalyticsView_module_css_default.chartAreaTop
							}), (0, react_jsx_runtime.jsx)("stop", {
								offset: "100%",
								className: SessionAnalyticsView_module_css_default.chartAreaBottom
							})]
						}) }),
						...
						series.map((s, i) => {
							...
							return (0, react_jsx_runtime.jsxs)("g", { children: [(0, react_jsx_runtime.jsx)("rect", {
								className: SessionAnalyticsView_module_css_default.chartBarIn,
								x: cx - barW / 2,
								y: inTop,
								width: barW,
								height: Math.max(1, baseline - inTop),
								rx: 2
							}), (0, react_jsx_runtime.jsx)("rect", {
								className: SessionAnalyticsView_module_css_default.chartBarOut,
								x: cx - barW / 2,
								y: outTop,
								width: barW,
								height: Math.max(1, inTop - outTop),
								rx: 2
							})] }, s.key);
						}),
						areaPath !== "" && (0, react_jsx_runtime.jsx)("path", {
							className: SessionAnalyticsView_module_css_default.chartArea,
							d: areaPath
						}),
					...
					children: [
						(0, react_jsx_runtime.jsxs)("span", {
							...
							children: [(0, react_jsx_runtime.jsx)("span", { className: SessionAnalyticsView_module_css_default.legendBarIn }), t("chart.input")]
						}),
						(0, react_jsx_runtime.jsxs)("span", {
							className: SessionAnalyticsView_module_css_default.legendItem,
							children: [(0, react_jsx_runtime.jsx)("span", { className: SessionAnalyticsView_module_css_default.legendBarOut }), t("chart.output")]
						}),
						(0, react_jsx_runtime.jsxs)("span", {
							className: SessionAnalyticsView_module_css_default.legendItem,
							children: [(0, react_jsx_runtime.jsx)("span", { className: SessionAnalyticsView_module_css_default.legendLine }), t("chart.total")]
						})
					]
				})]
			});
