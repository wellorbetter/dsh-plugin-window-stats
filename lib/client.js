window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = ".Ld-dQq_root{flex-direction:column;gap:14px;height:100%;padding:4px 2px;display:flex;overflow:auto}.Ld-dQq_ranges{flex-wrap:wrap;gap:6px;display:flex}.Ld-dQq_range{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:999px;padding:4px 12px;font-size:12px}.Ld-dQq_range:hover{background:var(--dsw-alias-interactive-bg-hover)}.Ld-dQq_rangeActive{color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-interactive-bg-hover);font-weight:600}.Ld-dQq_customRange{align-items:center;gap:4px;display:inline-flex}.Ld-dQq_customInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);width:56px;color:var(--dsw-alias-label-primary);border-radius:6px;padding:3px 8px;font-size:12px}.Ld-dQq_customSelect{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-primary);border-radius:6px;padding:3px 6px;font-size:12px}.Ld-dQq_summary{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-interactive-bg-hover);border-radius:10px;flex-wrap:wrap;gap:14px 24px;padding:10px 14px;display:flex}.Ld-dQq_stat{align-items:baseline;gap:7px;display:flex}.Ld-dQq_statLabel{color:var(--dsw-alias-label-tertiary);font-size:12px}.Ld-dQq_statValue{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:15px;font-weight:600}.Ld-dQq_section{flex-direction:column;gap:8px;display:flex}.Ld-dQq_sectionTitle{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:600}.Ld-dQq_emptyHint{color:var(--dsw-alias-label-tertiary);font-size:13px}.Ld-dQq_toolRow{grid-template-columns:110px 1fr 70px 70px;align-items:center;gap:10px;font-size:12px;display:grid}.Ld-dQq_toolName{color:var(--dsw-alias-label-primary);font-family:var(--ds-font-family-code,monospace);white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.Ld-dQq_toolTrack{background:var(--dsw-alias-interactive-bg-hover);border-radius:3px;height:7px;overflow:hidden}.Ld-dQq_toolFill{background:var(--dsw-alias-state-business-primary);border-radius:3px;height:100%}.Ld-dQq_toolCount{color:var(--dsw-alias-label-secondary);text-align:right;font-variant-numeric:tabular-nums}.Ld-dQq_toolDur{color:var(--dsw-alias-label-primary);text-align:right;font-variant-numeric:tabular-nums}.Ld-dQq_turnRow{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.Ld-dQq_turnHead{justify-content:space-between;align-items:baseline;display:flex}.Ld-dQq_turnTime{color:var(--dsw-alias-label-secondary);font-size:11px}.Ld-dQq_turnDur{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:11px}.Ld-dQq_turnPrompt{color:var(--dsw-alias-label-primary);-webkit-line-clamp:2;overflow-wrap:anywhere;-webkit-box-orient:vertical;font-size:13px;display:-webkit-box;overflow:hidden}.Ld-dQq_turnTools{flex-wrap:wrap;gap:4px;display:flex}.Ld-dQq_toolTag{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-secondary);font-size:11px;font-family:var(--ds-font-family-code,monospace);border-radius:999px;padding:1px 7px}.Ld-dQq_chart{width:100%;height:120px}.Ld-dQq_chartEmpty{color:var(--dsw-alias-label-tertiary);font-size:12px}.Ld-dQq_chartLegend{gap:14px;margin-top:4px;display:flex}.Ld-dQq_legendItem{color:var(--dsw-alias-label-secondary);align-items:center;gap:5px;font-size:11px;display:inline-flex}.Ld-dQq_legendDot{border-radius:2px;width:8px;height:8px}.Ld-dQq_toolLayout{align-items:flex-start;gap:14px;display:flex}.Ld-dQq_donutWrap{flex:0 0 96px}.Ld-dQq_donut{width:96px;height:96px}.Ld-dQq_toolRows{flex-direction:column;flex:1;gap:6px;min-width:0;display:flex}";
		...
		*/
		...
		function TokenTrendChart({ history, now, rangeMs, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("svg", {
				className: SessionAnalyticsView_module_css_default.chart,
				viewBox: `0 0 ${W} ${H}`,
				preserveAspectRatio: "none",
				role: "img",
				"aria-label": t("chart.tokens"),
				children: days.map((key, i) => {
					const d = history[key];
					const inH = max > 0 ? d.input / max * 114 : 0;
					const outH = max > 0 ? d.output / max * 114 : 0;
					const x = i * (barW + 1);
				...
				children: [(0, react_jsx_runtime.jsxs)("span", {
					...
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: SessionAnalyticsView_module_css_default.legendDot,
						style: {
							background: "#4176e6",
							opacity: .5
						}
		...
		const css = "._4IoqtG_sidebarRow{color:var(--dsw-alias-label-secondary);align-items:center;gap:6px;padding:2px 4px;font-size:11px;display:flex}._4IoqtG_sidebarText{white-space:nowrap}._4IoqtG_dot{background:#22c55e;border-radius:50%;flex:none;width:8px;height:8px}._4IoqtG_sidebarDot{color:var(--dsw-alias-label-primary);padding:0 4px;font-size:11px;font-weight:600}._4IoqtG_panel{background:var(--dsw-alias-button-elevated-fill);border:1px solid var(--dsw-alias-border-l2);pointer-events:auto;border-radius:12px;flex-direction:column;gap:10px;width:288px;padding:14px;display:flex;position:absolute;top:12px;bottom:12px;right:12px;overflow-y:auto;box-shadow:0 4px 16px #00000014}._4IoqtG_panelHead{justify-content:space-between;align-items:center;display:flex}._4IoqtG_panelTitle{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600}._4IoqtG_panelClose,._4IoqtG_panelToggle{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:6px;padding:3px 8px;font-size:11px}._4IoqtG_panelToggle{pointer-events:auto;position:absolute;top:12px;right:12px}._4IoqtG_panelStats{grid-template-columns:1fr 1fr;gap:8px;display:grid}._4IoqtG_panelStat{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-interactive-bg-hover);border-radius:8px;flex-direction:column;gap:2px;padding:8px 10px;display:flex}._4IoqtG_panelStatLabel{color:var(--dsw-alias-label-tertiary);font-size:11px}._4IoqtG_panelStatValue{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-weight:600}._4IoqtG_panelSection{flex-direction:column;gap:4px;display:flex}._4IoqtG_panelSectionTitle{color:var(--dsw-alias-label-secondary);padding-top:4px;font-size:12px;font-weight:600}._4IoqtG_panelEmpty{color:var(--dsw-alias-label-tertiary);font-size:12px}._4IoqtG_panelItem{color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:6px;justify-content:space-between;align-items:center;gap:8px;padding:5px 8px;font-size:12px;display:flex}._4IoqtG_panelItem:hover{background:var(--dsw-alias-interactive-bg-hover)}._4IoqtG_panelItemTitle{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._4IoqtG_panelItemValue{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;flex:none}";
		...
		*/
		function SidebarSummary({ wide, useSessions, t }) {
			const state = useSessions((s) => s);
			const totals = (0, react.useMemo)(() => aggregate(deriveWindowRows(state, { includeBlank: false })), [state]);
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				title: `${t("header.running")} · ${t("col.tokensIn")}`,
				children: [(0, react_jsx_runtime.jsx)("span", { className: Overview_module_css_default.dot }), (0, react_jsx_runtime.jsxs)("span", {
